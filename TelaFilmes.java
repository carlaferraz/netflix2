...
public class TelaFilmes extends JFrame {
    ...
    private void pedirDadosCompra() {
        try {
            ...
            int parcelas = 0;
            double valorFinalCompra = precoCompra;

            if (isAVista) {
                valorFinalCompra -= desconto;
            }
    ...
    public TelaFilmes() {
        ...
        JScrollPane scroll = new JScrollPane(listaFilmes);
        ...
        FileManager fileManager = new FileManager("./database/Filme.csv");
        ...
        listaFilmes.addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting()) {
                ...
                if (index >= 0) {
                    ...
                    JOptionPane.showMessageDialog(this, selecionado.toString(), "Detalhes do Filme", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        });
            ...
            if (index >= 0) {
                ...
                if (selecionado.isDisponivelParaCompra()) {
                    ...
                    JOptionPane.showMessageDialog(this,
                            "Este filme não está disponível para compra.",
                            "Compra", JOptionPane.WARNING_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(this,
                        "Selecione um filme para comprar.",
                        "Compra", JOptionPane.WARNING_MESSAGE);
            }
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(TelaFilmes::new);
    }
}
